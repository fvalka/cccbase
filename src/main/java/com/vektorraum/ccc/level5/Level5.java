...
public class Level5 extends Level {
    ...
    public String apply(List<String> strings) {
        ...
        if (width > 1) {
            ...
            if (direction.equals("O") || direction.equals("W")) {
                ...
                if (modus.equals("Z")) {
                    listPair = splitListWidthOne(rowOrder);
                } else {
                ...
                Pair<List<Integer>, List<Integer>> listPair;
                if (modus.equals("Z")) {
                    listPair = splitListWidthOne(colOrder);
                } else {
    ...
    private Pair<List<Integer>, List<Integer>> splitList(List<Integer> list) {
        ...
        return new Pair<List<Integer>, List<Integer>>(list2, list1);
    }
    ...
    public List<Integer> circularSwapList(List<Integer> list) {
        ...
        if (list.size() % 2 != 0) {
            result.add(list.get(list.size() % 2 + 1));
        }
        return result;
    }
    ...
    public static void main(String[] args) throws Exception {
        LevelRunner.runOnResourceFolder(new Level5(), "data/level5/in");
    }
}
